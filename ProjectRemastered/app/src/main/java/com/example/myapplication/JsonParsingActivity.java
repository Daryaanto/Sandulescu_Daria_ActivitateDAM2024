...
public class JsonParsingActivity extends AppCompatActivity {
    ...
    private List<Situatie> situatieList=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        situatieList=new ArrayList<>();

        Button extBtn = findViewById(R.id.extractBtn);
        extBtn.setOnClickListener((View v)->{
                ...
                public void run() {
                    ...
                    try{
                        ...
                        for (int i=0;i<4;i++){
                            ...
                            situatieList.add(new Situatie(disciplina,activitate,valoare,pondere,data,descriere));
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ArrayAdapter<Situatie> adapter=new ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_list_item_1,situatieList);
